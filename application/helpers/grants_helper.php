...
if(!function_exists('approval_action_button')){
    // function approval_action_button($table_name, $item_status, $item_id, $status_id, $item_initial_item_status_id, $item_max_approval_status_ids, $disable_btn=false, $confirmation_required = true, $custom_status_name = '', $voided_chq=false){
        function approval_action_button($table_name, $item_status, $item_id, $status_id, $item_initial_item_status_id, $item_max_approval_status_ids, $disable_btn=false, $confirmation_required = true, $custom_status_name = '', $voided_chq=false, $missing_voucher_detail_flag=false){
        $CI = &get_instance();
