...
<div class="row" style="margin-bottom:25px;">
  <div class="col-xs-12" style="text-align:center;">
        ...
        <div class = "btn btn-default" id = 'btn_manage_columns'><?=get_phrase('show_hide_columns','Show/Hide Columns');?></div>
  </div>
</div>
...
<div class="row">
    <div class = "col-xs-12 hide" id = "manage_columns" style = "margin-bottom: 20px;">
            <select class="form-control select2" id = "fields-select" multiple>
                <option data-column = "0" value = "0"><?=get_phrase('action');?></option>
