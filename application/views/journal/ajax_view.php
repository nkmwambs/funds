                ...
                ?>
                    ...
                    <tr>
                        <td>
                            ...
                            ?>
                                <div data-voucher_id='<?= $voucher_id; ?>' class='btn btn_reverse  <?= $cancel_eft_class; ?> <?= !$role_has_journal_update_permission || $result['mfr_submited_status'] == 1 ? "disabled" : ''; ?> <?= $voucher_is_reversed || $voucher_is_cleared ? "hidden" : ""; ?> <?= $voucher_is_cleared ? "hidden" : ""; ?>'>
...
<script>
    ...
    $(".btn_reverse").on('click', function() {
        ...
        if (reuse_cheque) {
            ...
            reuse_transaction = reuse_cheque;
        ...
        if (cnfrm) {
            ...
            $.get(url_check, function(response_voucher_cancelled) {
                ...
                if (parseInt(response_voucher_cancelled) == 1) {
                    ...
                    var url = "<?= base_url(); ?>Journal/reverse_voucher/" + voucher_id + "/" + reuse_transaction + "/" + reusing_eft_or_chq_number+"/"+journal_month;
