            ...
            <div class="panel-body" style="max-width:50; overflow: auto;">
                ...
                <div class='form-group'>
                    <div class='col-xs-12' style='text-align:center;'>
                        ...
                        <button class='btn btn-default btn-save-new disabled'><?=get_phrase('save_and_new','Save and New');?></button>
                    </div>
                </div>
                ...
                <div class='form-group'>
                    ...
                    <label class='col-xs-2 control-label'><?=get_phrase('office_description','Office Description');?></label>
                    <div class='col-xs-4'>
                ...
                <div class='form-group'>
                    ...
                    <label class='col-xs-2 control-label'><?=get_phrase('office_start_date','Office Start Date');?></label>
                    <div class='col-xs-4'>
                ...
                <div class='form-group'>
                    <label class='col-xs-2 control-label'><?=get_phrase('context_definition','Context Definition');?></label>
                    <div class='col-xs-4'>
                        <?= $this->grants->header_row_field('context_definition_name'); ?>
                    </div>

                    <label class='col-xs-2 control-label'><?=get_phrase('reporting_context','Reporting Context');?></label>
                ...
                <div class=' <?=!$this->session->system_admin? "hidden":" ";?> form-group'>
                    <label class='col-xs-2 control-label hidden'><?=get_phrase('is_office_active','Is Office Active?');?></label>
                    <div class='col-xs-4 hidden'>
                        <?= $this->grants->header_row_field('office_is_active', 1); ?>
                    </div>

                    <label class="col-xs-2 control-label <?=!$this->session->system_admin? "hidden":" ";?>"><?=get_phrase('office_account_system','Office Accounting System');?></label>
                    <div class='col-xs-4'>
                        <?php 
