...
<div class="row" style="margin-bottom:25;">
  <div class="col-xs-12" style="text-align:center;">
        <?php 
            ...
            if(!$office_has_financial_report_submitted && $show_add_button && $this->user_model->check_role_has_permissions(ucfirst($table_name),'create') && $this->grants->show_add_button($table_name)){
