...
<div class='row'>
    ...
    <div class='col-xs-offset-2 col-xs-8 col-xs-offset-2' style='text-align:center;'>
        ...
        ?>
            ...
            <a href = "<?=base_url();?>budget_limit/single_form_add/<?=$this->id;?>/budget" class = "btn btn-default"><?=get_phrase('add_budget_limit');?></a>
        <?php 
        }
        ?>
        </div>
...
<div class='row warning <?=$budget_message == '' ? 'hidden': 'show'?>'>
    <div class='col-xs-12'>
        <?=$budget_message;?>
    </div>
</div>
...
<div class='row'>
    <div class='col-xs-12'>
        ...
        if(empty($summary)){
        ?>
            <div style="font-weight: bold;" class = "info"><?=get_phrase('missing_budget_items','No Budget Items Posted to this Budget');?></div>
        <?php
        }
        //print_r($summary[2]);
