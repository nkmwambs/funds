...
class Office_bank extends MY_Controller
{
  ...
  public function validate_office_bank_account($office_bank_id){
    ...
    $account_balance = $this->office_bank_model->office_bank_account_balance($office_bank_id, $reporting_month);
