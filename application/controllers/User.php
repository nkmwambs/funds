...
class User extends MY_Controller
{
  ...
  private function assign_user_active_status($account_system_id, $user_context_definition_id){
    $active_status = 0;
  ...
  function create_new_user()
  {
    ...
    $user['user_is_active'] = $this->assign_user_active_status($post['account_system_id'], $post['fk_context_definition_id']); // A user has to be full approved to have the record active. Normal approval flow to be followed.
    $user['md5_migrate'] = 1; //For migrating fro use of php MD5 to complex sha256 with salt
