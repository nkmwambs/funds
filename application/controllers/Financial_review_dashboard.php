...
class Financial_review_dashboard extends MY_Controller
{
  ...
  function format_balances_parameters(&$financial_report,$office_id, $reporting_month){
    ...
    if($financial_report['closing_total_statement_balance_data'] != null){
      $decode_result = !is_null($financial_report['closing_total_statement_balance_data']) ? json_decode($financial_report['closing_total_statement_balance_data'],true): [];
    ...
    if($financial_report['closing_fund_balance_data'] != null){
      $decode_result = !is_null($financial_report['closing_fund_balance_data']) ? json_decode($financial_report['closing_fund_balance_data'],true) : [];
      if(!empty($decode_result)){
    ...
    if($financial_report['closing_total_cash_balance_data'] != null){
      $decode_result = !is_null($financial_report['closing_total_cash_balance_data']) ? json_decode($financial_report['closing_total_cash_balance_data'],true) : [];
      if(!empty($decode_result)){
    ...
    if($financial_report['closing_outstanding_cheques_data'] != null){
      $decode_result = !is_null($financial_report['closing_outstanding_cheques_data']) ? json_decode($financial_report['closing_outstanding_cheques_data'],true) : [];
      if(!empty($decode_result)){
    ...
    if($financial_report['closing_transit_deposit_data'] != null){
      $decode_result = !is_null($financial_report['closing_transit_deposit_data']) ? json_decode($financial_report['closing_transit_deposit_data'],true) : [];
      if(!empty($decode_result)){
    ...
    if($financial_report['closing_overdue_cheques_data'] != null){
      $decode_result = !is_null($financial_report['closing_overdue_cheques_data']) ? json_decode($financial_report['closing_overdue_cheques_data'],true) : [];
      if(!empty($decode_result)){
    ...
    if($financial_report['closing_overdue_deposit_data'] != null){
      $decode_result = !is_null($financial_report['closing_overdue_deposit_data']) ? json_decode($financial_report['closing_overdue_deposit_data'],true) : [];
      if(!empty($decode_result)){
