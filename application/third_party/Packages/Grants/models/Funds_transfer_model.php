...
class Funds_transfer_model extends MY_Model{
    ...
    function post_approval_action_event($item){
        ...
        if(in_array($next_status, $item_max_approval_status_ids)){
            ...
            if($is_approved_funds_transfer > 0){
               ...
               // $this->journal_model->reverse_voucher($funds_transfer->row()->fk_voucher_id);
    ...
    function create_funds_transfer_voucher($funds_transfer_id){
        ...
        $cash_received_voucher_type = $this->voucher_type_model->get_hidden_voucher_type('bank','income')->voucher_type_id;

        $cash_expense_voucher_type = $this->voucher_type_model->get_hidden_voucher_type('bank','expense')->voucher_type_id;
