...
class Office_bank_model extends MY_Model 
{
  ...
  public function detail_tables(){
    ...
    function action_before_edit($post_array){
      ...
      if(!empty($leaves) && $exemption_date != ''){
        return ['error' => get_phrase('disallow_office_bank_cheque_book_expiry','You are not allowed to set a cheque book use expiry date when the current cheque book is not depleted or deactivated.')];
      }
