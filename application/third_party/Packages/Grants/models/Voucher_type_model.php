...
class Voucher_type_model extends MY_Model 
{
  ...
  function get_hidden_voucher_type($voucher_type_account_code,$voucher_type_effect_code){
    ...
    $this->read_db->where(array('fk_account_system_id' => $this->session->user_account_system_id,'voucher_type_is_cheque_referenced' => 0));
