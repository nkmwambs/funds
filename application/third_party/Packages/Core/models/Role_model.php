...
class Role_model extends MY_Model
{
  ...
  function single_form_add_visible_columns(){
    $columns = ['role_name','role_shortname','role_description','role_is_active','role_is_new_status_default','role_is_department_strict','context_definition_name','account_system_name'];

    if(!$this->session->system_admin){
        $columns = ['role_track_number','role_name','role_description','role_is_active','context_definition_name','account_system_name'];
    }
